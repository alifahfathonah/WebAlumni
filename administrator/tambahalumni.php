                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><i class="fa fa-pencil"></i> Tambah Alumni</li>
                        </ol>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="post" role="form" enctype="multipart/form-data">
                            <table class="table-responsive table">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 200px;"><label>No Alumni</label></td>
                                        <td style="width: 1px;">:</td>
                                        <td>
                                            <input type="text" name="no_alumni" value="" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 1px;">:</td>
                                        <td>
                                            <input type="text" name="nama_alumni" value="" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 1px;">:</td>
                                        <td>
                                            <input type="text" name="judul_skripsi" value="" class="form-control">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 1px;">:</td>
                                        <td>
                                            <input type="text" name="tanggal_lulus" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 1px;">:</td>
                                        <td>
                                            <input type="date" name="tanggal_widsuda" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
