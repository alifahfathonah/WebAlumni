                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><i class="fa fa-book"></i> Kontak</li>
                        </ol>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" href="hapuskontak.php?id_kontak=<?php echo $row['id_kontak']; ?>" onclick="return confirm('Are you sure delete this data?');">Delete</a>
                                        </td>
