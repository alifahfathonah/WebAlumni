                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="?page=user"><i class="fa fa-upload"></i>Upload Data</a></li>
                            <li class="active"><i class="fa fa-pencil"></i> Upload Data</li>
                        </ol>
                    ...
                    <div class="col-lg-12">
                        <form method="post" role="form" enctype="multipart/form-data">
                            <table class="table-responsive table">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 200px;"><label>Upload Data</label></td>
