        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="berita.php"><i class="fa fa-fw fa-upload"></i>
                            Upload</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><i class="fa fa-search"></i> Lowongan Kerja</li>
                        </ol>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <a href="tambahloker.php" class="btn btn-primary">+ Tambah Data Baru</a>
                        </div>
                            ...
                            <table class="table table-hover data-table table-striped tablesorter" id="table_id">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="header">Perusahaan</th>
                                        <th class="header">Lokasi</th>
                                        <th class="header">Deskripsi</th>
                                        <th class="header">Tanggal Post</th>
                                        <th class="header">Tanggal Close</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../images/<?php echo $row['images']; ?>" style="width: 100px;" alt=""></td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="editloker.php?id_loker=<?php echo $row['id_loker']; ?>">Edit</a>
                                            <a class="btn btn-danger btn-sm" href="hapusloker.php?id_loker=<?php echo $row[" id_loker"]; ?>" onclick="return confirm('Are you sure delete this data?');">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php endforeach; ?>
